  ...
  const experience = [
    {
      ...
      highlights: [
        ...
        "Reduced production defects by 40% through improved CI pipeline stability and comprehensive pre-merge validation"
      ]
    },
    {
      ...
      <style>{`
        ...
        @media print {
          ...
          * {
          ...
          h2 { font-size: 0.95rem !important; margin-bottom: 0.5rem !important; color: white !important; }
          h3 { font-size: 0.85rem !important; color: white !important; }
          p { font-size: 0.75rem !important; line-height: 1.4 !important; margin-bottom: 0.35rem !important; }
          li { font-size: 0.72rem !important; line-height: 1.35 !important; margin-bottom: 0.15rem !important; }
            ...
            <section className="cv-section mb-6 print-bg-light rounded-xl p-4 bg-slate-800/50">
              ...
              <div className="text-gray-300 print-muted-text leading-relaxed space-y-3">
                ...
                <p>
                  ...
                  driving shift-left quality culture across engineering organisations. Positioned as an emerging technical leader with 
                  a proven trajectory toward principal-level engineering influence.
                </p>
              </div>
            </section>
