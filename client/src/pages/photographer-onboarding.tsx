...
export default function PhotographerOnboarding() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col p-6 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[25%] bg-primary/5 blur-[60px] rounded-full pointer-events-none" />
      ...
      <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Let's set up your photographer profile so customers can find you.</p>
        </div>
        ...
        <form onSubmit={handleComplete} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <Textarea 
              ...
              className="bg-card border-white/10 text-white min-h-[100px] rounded-xl focus:border-primary focus:ring-primary/20 resize-none"
