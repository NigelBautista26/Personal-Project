  ...
  return (
    <div className="min-h-screen bg-background flex flex-col p-6 relative overflow-hidden">
      ...
      <div className="flex items-center mb-8 mt-4">
        <Link href="/">
          <button className="w-10 h-10 glass-dark rounded-full flex items-center justify-center text-white hover:bg-white/10 transition-colors">
      ...
      <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button type="button" className="h-12 glass-dark rounded-xl border border-white/10 flex items-center justify-center hover:bg-white/5 transition-colors">
